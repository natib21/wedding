...
import { Heart, User, Phone, ArrowRight, AlertCircle, Loader2, Shield } from "lucide-react";
...
export default function LoginPage({ mode = "guest" }: LoginPageProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div className="absolute bottom-1/4 right-1/4 size-96 bg-violet-500/10 rounded-full blur-3xl" />
      </div>
      ...
      <motion.div
        ...
        className={cn("relative w-full max-w-md", shake && "animate-shake")}
      >
        ...
        <div className="relative bg-slate-900/80 backdrop-blur-xl border border-slate-800/50 rounded-3xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 text-sm">
              {isAdminLogin
                ? "Sign in to manage guests and scan check-in QR codes"
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  required
                  className="pl-12 h-12 bg-slate-800/50 border-slate-700/50 text-white placeholder:text-slate-500 rounded-xl"
                />
              </div>
            </div>
            ...
            <Button
              ...
              className="w-full h-12 bg-gradient-to-r from-indigo-500 to-violet-500 hover:from-indigo-600 hover:to-violet-600 text-white font-medium rounded-xl"
            >
              {isLoading ? (
                <Loader2 className="size-5 animate-spin" />
              ) : (
                <>
                  {isAdminLogin ? "Sign in as admin" : "Continue"}
